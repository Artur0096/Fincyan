...
export default function ErrorPage(props ,{ ...rest }) {
  React.useEffect(() => {
    window.scrollTo(0, 0);
  ...
  return (
    <div>
      <Header
        ...
        links={<HeaderLinks dropdownHoverColor="dark"  isAuthenticated={props.isAuthenticated} userHasAuthenticated = {props.userHasAuthenticated}/>}
        {...rest}
      />
      <div
