  ...
  React.useEffect(() => {
    ...
    async function handleConfirmationSubmit(event) {
        ...
        try {
            ...
            await Auth.signIn(firstName, email, password);
            props.userHasAuthenticated(true);
            history.push("/plan-with-fincyan");
            console.log(props);
                  ...
                  <GridContainer justify="center">
                    ...
                    <GridItem xs={12} sm={5} md={5}>
                      <div className={classes.textCenter}>
                        ...
                        />
                        <div className={classes.textCenter}>
                          <Button round color="primary" onClick={handleClick}>
                            Get started
                          </Button>
                        </div>
                              </form>}
                        ...
                        {confirmSignUp &&
                          ...
                          />
                          <div className={classes.textCenter}>
                              <Button round color="primary" onClick={handleConfirmationSubmit}>
                                  Confirm
                              </Button>
                          </div>
                                  </form>
